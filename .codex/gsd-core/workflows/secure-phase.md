...
```
Agent(
  prompt="Read C:/Users/hiday/WebstormProjects/zephyra-agenticai-library/.codex/agents/gsd-security-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `C:/Users/hiday/WebstormProjects/zephyra-agenticai-library/.codex/gsd-core/templates/SECURITY.md`
