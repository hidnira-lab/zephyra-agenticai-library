...
The keys live in `.codex/settings.json` (project) or `C:/Users/hiday/WebstormProjects/zephyra-agenticai-library/.codex/settings.json` (global) — **not** in `.planning/config.json`:
